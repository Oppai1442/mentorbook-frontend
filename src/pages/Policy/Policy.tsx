    ...
    <div className={`${styles.policyContainer}`}>
      ...
      <section className="my-4">
        ...
        <ul>
          ...
          <li>Improve your experience on the website by personalizing content and features.</li>
          <li>Respond to your inquiries, requests, or support needs.</li>
          <li>Send you promotional materials, newsletters, or other information related to our services (with your consent).</li>
          <li>Analyze trends, monitor usage, and enhance the performance of the website.</li>
      ...
      <section className="my-4">
        ...
        <ul>
          ...
          <li><strong>Right to Rectification:</strong> You have the right to request correction of any inaccuracies in your personal information.</li>
          <li><strong>Right to Erasure:</strong> You can request that we delete your personal information, subject to certain exceptions.</li>
          ...
          <li><strong>Right to Data Portability:</strong> You can request a copy of your personal information in a machine-readable format to transfer to another service.</li>
